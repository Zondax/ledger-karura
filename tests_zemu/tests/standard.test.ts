...
describe('Standard', function () {
  ...
  test.each(models)('get address', async function (m) {
    ...
    try {
      ...
      const expected_address = 'sCFFBRb4EXvazWmoBieJWpeqKLQVJpc9BDfLKa2tLfsrxdT'
      const expected_pk = 'ac5752c2c18bcbb882a938df5b8ccee7be8d2f332a1496c841eb695bf6ebb30a'
