...
__Z_INLINE parser_error_t _readMethod_honzonbridge_from_bridged_V1(
    parser_context_t* c, pd_honzonbridge_from_bridged_V1_t* m)
{
    CHECK_ERROR(_readCompactu128(c, &m->amount))
    return parser_ok;
}
    ...
    uint8_t pageIdx, uint8_t* pageCount)
{
    ...
    case 27137: /* module 106 call 1 */
        ...
        case 0: /* honzonbridge_from_bridged_V1 - amount */;
            return _toStringCompactu128(
                &m->basic.honzonbridge_from_bridged_V1.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
