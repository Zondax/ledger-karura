...
__Z_INLINE parser_error_t _readMethod_honzonbridge_set_bridged_stable_coin_address_V3(
    parser_context_t* c, pd_honzonbridge_set_bridged_stable_coin_address_V3_t* m)
{
    CHECK_ERROR(_readEvmAddress(c, &m->address))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_honzonbridge_to_bridged_V3(
    parser_context_t* c, pd_honzonbridge_to_bridged_V3_t* m)
{
    CHECK_ERROR(_readCompactu128(c, &m->amount))
    return parser_ok;
}

__Z_INLINE parser_error_t _readMethod_honzonbridge_from_bridged_V3(
    parser_context_t* c, pd_honzonbridge_from_bridged_V3_t* m)
{
    CHECK_ERROR(_readCompactu128(c, &m->amount))
    return parser_ok;
}
    ...
    pd_Method_V3_t* method)
{
    ...
    case 27136: /* module 106 call 0 */
        CHECK_ERROR(_readMethod_honzonbridge_set_bridged_stable_coin_address_V3(c, &method->basic.honzonbridge_set_bridged_stable_coin_address_V3))
        break;
    case 27137: /* module 106 call 1 */
        CHECK_ERROR(_readMethod_honzonbridge_to_bridged_V3(c, &method->basic.honzonbridge_to_bridged_V3))
        break;
    case 27138: /* module 106 call 2 */
        CHECK_ERROR(_readMethod_honzonbridge_from_bridged_V3(c, &method->basic.honzonbridge_from_bridged_V3))
        break;
    ...
    uint8_t pageIdx, uint8_t* pageCount)
{
    ...
    case 27136: /* module 106 call 0 */
        switch (itemIdx) {
        case 0: /* honzonbridge_set_bridged_stable_coin_address_V3 - address */;
            return _toStringEvmAddress(
                &m->basic.honzonbridge_set_bridged_stable_coin_address_V3.address,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 27137: /* module 106 call 1 */
        switch (itemIdx) {
        case 0: /* honzonbridge_to_bridged_V3 - amount */;
            return _toStringCompactu128(
                &m->basic.honzonbridge_to_bridged_V3.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
    ...
    case 27138: /* module 106 call 2 */
        switch (itemIdx) {
        case 0: /* honzonbridge_from_bridged_V3 - amount */;
            return _toStringCompactu128(
                &m->basic.honzonbridge_from_bridged_V3.amount,
                outValue, outValueLen,
                pageIdx, pageCount);
        default:
            return parser_no_data;
