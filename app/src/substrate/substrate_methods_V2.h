...
#define PD_CALL_HONZONBRIDGE_V2 106
...
#define PD_CALL_HONZONBRIDGE_SET_BRIDGED_STABLE_COIN_ADDRESS_V2 0
typedef struct {
    pd_EvmAddress_V2_t address;
} pd_honzonbridge_set_bridged_stable_coin_address_V2_t;

#define PD_CALL_HONZONBRIDGE_TO_BRIDGED_V2 1
typedef struct {
    pd_Compactu128_t amount;
} pd_honzonbridge_to_bridged_V2_t;

#define PD_CALL_HONZONBRIDGE_FROM_BRIDGED_V2 2
typedef struct {
    pd_Compactu128_t amount;
} pd_honzonbridge_from_bridged_V2_t;
...
typedef union {
    ...
    pd_honzonbridge_set_bridged_stable_coin_address_V2_t honzonbridge_set_bridged_stable_coin_address_V2;
    pd_honzonbridge_to_bridged_V2_t honzonbridge_to_bridged_V2;
    pd_honzonbridge_from_bridged_V2_t honzonbridge_from_bridged_V2;
