...
|Set swap balance threshold |    | :heavy_check_mark: |   | `CurrencyId` currency_id <br/>`Balance` swap_threshold <br/> |
|Enable charge fee pool |    | :heavy_check_mark: |   | `CurrencyId` currency_id <br/>`Balance` pool_size <br/>`Balance` swap_threshold <br/> |
...
| Name        | Light | XL | Nesting | Arguments |
| :---------- |:------------:|:--------:|:--------:|:--------|
|Update xcm dest weight and fee |    |   |   | `VecTupleHomaXcmOperationOptionWeightOptionBalance` updates <br/> |
